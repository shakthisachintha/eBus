...
const bookSeats = (busId,bookingDate,numOfSeats,startPoint,endPoint,busNo) => client.get("/booking/bookSeat/"+busId+"/"+bookingDate+"/"+numOfSeats+"/"+startPoint+"/"+endPoint+"/"+busNo);
